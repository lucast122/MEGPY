...
def change_min_identity():
    mapping_file_path = "/Volumes/Timo_HDD/"
    ...
    for file in glob.glob(mapping_file_path + "*.daa"):
        ...
        with open("Change_parameters/" + mapping_file_name + '_commands.txt', 'w') as the_file:
            ...
            command = MEGAN_COMMAND + \
                      "Change_parameters/" + str(mapping_file_name) + "_commands.txt"
